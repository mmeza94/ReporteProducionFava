...
namespace Tenaris.Fava.Production.Reporting.Model.Support
{
    public class ReportProductionHistoryFacade
    {
        ...
        public ReportProductionHistory GetReportProductionHistoryByIdHistory(string extremo, int orderNumber,
            int heatNumber, int groupItemNumber)
        {
            return new ReportProductionHistoryRepository().GetReportProductionHistoryByIdHistory(extremo, orderNumber,
