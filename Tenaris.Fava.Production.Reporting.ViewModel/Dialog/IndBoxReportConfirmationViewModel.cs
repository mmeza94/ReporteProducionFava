...

    {
        ...
        public IndBoxReportConfirmationViewModel(GeneralPiece generalPieceDto, ReportProductionDto productionReportDto, string user)
        {
            ...
            if (total <= 0)
            {
                ...
                string itresponse = "";
                DataTable res = adapter.GetAvailableStock(generalPieceDto.OrderNumber.ToString(), currentGeneralPiece.Description, Configurations.Instance.Opcion,null,null,ref itresponse);
