    ...
    public class ProductionReportViewModel : ViewModelBase
    {
        ...
        public ProductionReportViewModel()
        {
            try
            {
                ...
                LabelMachine = string.IsNullOrEmpty(ConfigurationManager.AppSettings["LabelMachine"].ToString()) ? ConfigurationManager.AppSettings["Machine"].ToString().ToUpper() : ConfigurationManager.AppSettings["LabelMachine"].ToString().ToUpper();
        ...
        {
            if (Configurations.Instance.VersionApplication.Equals("V4") && Convert.ToInt32(Configurations.Instance.Secuencia) <=4)
            {
                IsVisibility = Visibility.Collapsed;
                IsVisibility2 = Visibility.Visible;
                IsVisibilityCantTot = Visibility.Visible;
                IsVisibilityCoples = Visibility.Collapsed;
                IsVisibilityExtremo = Visibility.Collapsed;
                //var hola = Type.ReflectionOnlyGetType("Maquina1", false, true);
                //var hola2 = Type.GetType("Maquina2");
            }
            else if (Configurations.Instance.VersionApplication.Equals("V4"))
            {                
                IsVisibility = Visibility.Collapsed;
                IsVisibility2 = Visibility.Visible;
                IsVisibilityCantTot = Visibility.Visible;
                IsVisibilityCoples = Visibility.Visible;
                IsVisibilityExtremo = Visibility.Visible;
            }
        ...
        private Visibility isVisibilityCoples;
        private Visibility isVisibilityExtremo;
        ...
        public Visibility IsVisibilityCoples
        {
            get { return isVisibilityCoples; }
            set
            {
                if (value == isVisibilityCoples) return;
                isVisibilityCoples = value;
                onPropertyChanged("IsVisibilityCoples");
            }
        }

        public Visibility IsVisibilityExtremo
        {
            get { return isVisibilityExtremo; }
            set
            {
                if (value == isVisibilityExtremo) return;
                isVisibilityExtremo = value;
                onPropertyChanged("IsVisibilityExtremo");
            }
        }
